...
int main(void) {
	...
	p = cherche_i("leu",l);
	printf("cherche_i(leu) : %s\n",estVide(p)?"pas trouve":"[ERREUR] trouve !!!");

	p = cherche_i("t",l);
	if(estVide(p))
		printf("cherche_i(t) : [ERREUR] pas trouve \n");
	else {
		printf("cherche_i(t) : trouve ");
		afficheElement(p->val);
		printf("\n");
	}

	p = cherche_r("f",l);
	printf("cherche_r(f) : %s\n",estVide(p)?"pas trouve":"[ERREUR] trouve !!!");

	p = cherche_r("t",l);
	if(estVide(p))
		printf("cherche_r(t) : [ERREUR] pas trouve \n");
	else {
		printf("cherche_r(t) : trouve ");
		afficheElement(p->val);
		printf("\n");
	}
